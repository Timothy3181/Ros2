...
#ifndef PRACTICE__MSG__DETAIL__SYSTEM_STATUS__STRUCT_HPP_
#define PRACTICE__MSG__DETAIL__SYSTEM_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__practice__msg__SystemStatus __attribute__((deprecated))
#else
# define DEPRECATED__practice__msg__SystemStatus __declspec(deprecated)
#endif
...
struct SystemStatus_
{
  ...
  using _cpu_available_type =
    float;
  _cpu_available_type cpu_available;
  ...
  Type & set__cpu_available(
    const float & _arg)
  {
    this->cpu_available = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    practice::msg::SystemStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const practice::msg::SystemStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<practice::msg::SystemStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<practice::msg::SystemStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      practice::msg::SystemStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<practice::msg::SystemStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<practice::msg::SystemStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<practice::msg::SystemStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<practice::msg::SystemStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__practice__msg__SystemStatus
    std::shared_ptr<practice::msg::SystemStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__practice__msg__SystemStatus
    std::shared_ptr<practice::msg::SystemStatus_<ContainerAllocator> const>
  ...
  bool operator==(const SystemStatus_ & other) const
  {
    ...
    if (this->cpu_available != other.cpu_available) {
      return false;
    }
...
using SystemStatus =
  practice::msg::SystemStatus_<std::allocator<void>>;
...
#endif  // PRACTICE__MSG__DETAIL__SYSTEM_STATUS__STRUCT_HPP_
