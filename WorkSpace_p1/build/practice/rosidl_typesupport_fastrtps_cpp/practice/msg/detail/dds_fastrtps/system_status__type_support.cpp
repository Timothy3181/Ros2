...
#include "practice/msg/detail/system_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = practice::msg::SystemStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const practice::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<practice::msg::SystemStatus *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_practice
const rosidl_message_type_support_t *
get_message_type_support_handle<practice::msg::SystemStatus>()
{
  return &practice::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
