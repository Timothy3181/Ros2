...
bool practice__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("practice.msg._system_status.SystemStatus", full_classname_dest, 40) == 0);
  }
  practice__msg__SystemStatus * ros_message = _ros_message;
  {  // stamp
  ...
  {  // cpu_available
    PyObject * field = PyObject_GetAttrString(_pymsg, "cpu_available");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cpu_available = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_percent
...
PyObject * practice__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("practice.msg._system_status");
  ...
  {  // cpu_available
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cpu_available);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cpu_available", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
